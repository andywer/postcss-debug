...
var argv = require('yargs').usage('Usage: $0 [-c <config file>] <css files...>').demand(1).alias('c', 'config').default('c', '.postcss.js').nargs('c', 1).describe('c', 'Config file specifying the postcss plugins to use').help('?').alias('?', 'help').argv;
