...
function createDebugger() {
  ...
  var debuggerInstance = new _debugger2.default(matchers, options);
  ...
  function pluginWrapper(plugins) {
    ...
    plugins.forEach(function (plugin) {
      pluginsAndSnapshotters.push(debuggerInstance.createSnapshoter({ prevPlugin: prevPlugin, nextPlugin: plugin }));
      pluginsAndSnapshotters.push(plugin);
      prevPlugin = plugin;
    });

    pluginsAndSnapshotters.push(debuggerInstance.createSnapshoter({ prevPlugin: prevPlugin }));
